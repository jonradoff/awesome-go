...
- [LightCMS](https://github.com/jonradoff/lightcms) - Self-hosted CMS, human or headless, with MCP tooling, semantic search and site chat, content versioning, forking, and diff/merge review.
